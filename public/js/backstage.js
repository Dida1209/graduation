...
//课程属性
        var d = [[{'name': '顺序表', 'child': ''}, {'name': '链表', 'child': ['线性链表', '循环链表', '双向链表']}], [{
            'name': '栈',
            'child': ''
        }, {'name': '队列', 'child': ['循环队列', '链队列']}], [{'name': '树', 'child': ''}, {
            'name': '二叉树',
            'child': ['遍历二叉树', '线索二叉树']
        }, {'name': '森林', 'child': ''}, {'name': '赫尔曼树', 'child': ''}], [{'name': '遍历图', 'child': ''}, {
            'name': '图的连通性',
            'child': ''
        }, {'name': '最短路径', 'child': ''},], [{
            'name': '静态查找表',
            'child': ['顺序表查找', '有序表查找', '索引顺序表查找']
        }, {'name': '动态查找表', 'child': ['二叉排序树', '平衡二叉树']}, {'name': '哈希表', 'child': ''}], [{
            'name': '插入排序',
            'child': ''
        }, {'name': '快速排序', 'child': ''}, {'name': '选择排序', 'child': ['简单排序', '堆排序']}]];
        ...
        if (typeKey == 2) {
            ...
            $.ajax({
                ...
                if (results.success == 1) {
                    console.log("ok");
                    window.location.href = '/resource/' + results.resource._id;
                }
            })
        } else {
            if (typeKey == 3) {
